...
> 原题单链接：[能力全面提升综合题单](https://www.luogu.com.cn/training/9391)
>
> 题单来源：[StudyingFather's Blog](https://studyingfather.com/archives/841)

## 项目简介

本项目包含了洛谷综合题单的完整解题代码，是个人学习算法和数据结构的实践记录。所有代码均通过洛谷平台测试，可供参考学习。
...
- [P1089 储蓄计划](https://www.luogu.com.cn/problem/P1089)
...
#### Part 1.3 - 字符串基础
- [P1012 [NOIP1998 普及组] 拼数](https://www.luogu.com.cn/problem/P1012)
...
#### Part 1.4 - 递归与动态规划
- [P1025 [NOIP2001 普及组] 数的划分](https://www.luogu.com.cn/problem/P1025)
- [P1028 [NOIP2001 普及组] 数的计算](https://www.luogu.com.cn/problem/P1028)
- [P1036 [NOIP2002 普及组] 选数](https://www.luogu.com.cn/problem/P1036)
- [P1192 [NOIP2010 普及组] 台阶问题](https://www.luogu.com.cn/problem/P1192)
...
2. 文件命名格式为 `P题号.cpp`
3. 所有代码均在 C++17 标准下编译通过
4. 建议按 Part 顺序学习，循序渐进
